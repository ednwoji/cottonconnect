...
public class Role extends AuditableBase {
	...
	@ManyToMany
	@JoinTable(name = "cc_role_ent_map", joinColumns = @JoinColumn(name = "role_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "ent_id", referencedColumnName = "id"))
	@JsonIgnore
