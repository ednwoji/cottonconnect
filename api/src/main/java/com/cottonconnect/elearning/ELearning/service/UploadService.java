...
public interface UploadService {
	...
	public void saveLpUploadFarmer(List<UploadLpExcelDTO> excelData, UploadLpDTO uploadLPDTO) throws CustomException;
	...
	String saveFileToCpanel(MultipartFile documentFile) throws IOException;
}
