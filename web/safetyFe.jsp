					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="safetylistFe.jsp">Safety
										& Hygiene</a></li>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Safety & Hygiene in Agriculture</label> <input type="text"
												class="form-control" required id="name" name="name" oninput="validateInput('name')">
										</div>
									</div>
    ...
    textarea.setCustomValidity("");
		...
		$(document).ready(function () {
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			...
			$("#redirectUrl").val(getHomeUrl() + "/safetyFe.jsp");
