					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="usefullist.jsp">Useful
										information</a></li>
						...
						<div class="card-body">
							<form action=""
									...
									<div class="col-md-4">
										<div class="form-group">
											<label>Upload<b style="color: red">[.jpg, .png]</b> [Max size : Upto to
												1MB]</label> <input type="file" name="file" accept="image/jpeg, image/png" class="form-control">
										</div>
									</div>
								...
								<div class="modal-footer">
									<a href="usefullist.jsp" class="btn btn-outline-primary">Cancel</a>
    ...
    textarea.setCustomValidity("");
		...
		$(document).ready(function () {
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			...
			$("#redirectUrl").val(getHomeUrl() + "/useful.jsp");
