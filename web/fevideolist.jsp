	...
	<main>
		<div class="container-fluid">
			<div class="row" >
				<div class="col-12">
					<div class="mb-2">
						<h1>Field Executive Video</h1>
						<div class="top-right-button-container">
							<a href="fevideo.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function fillDataTable() {
			$('#country-table').DataTable({
				"processing" : true,
				"serverSide" : true,
				"ajax" : getUrl()+ '/video/getAllRecords/2',
			});
		}
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					...
					success : function(result) {
						...
						window.location.href = "fevideolist.jsp";
					}
				});
			} else {
				$("body").removeClass("show-spinner");
		...
		function editz(id) {
			$("body").addClass("show-spinner");
			window.location.href = "fevideo.jsp?id=" + id;
		}
	</script>
