...
<body id="app-container" class="menu-sub-hidden show-spinner">
					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="fertilizerListFe.jsp">Fertilizer</a></li>
								<li class="breadcrumb-item active" aria-current="page">List</li>
							</ol>
						</nav>
						<div class="top-right-button-container">
							<a href="fertilizerFe.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function edit(id) {
			...
			window.location.href = "fertilizerFe.jsp?id="+id;
		}
		...
		function deletez(id) {
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					url : getUrl() + '/service/knowledge-center/delete?id='
							+ id,
					...
					success : function(result) {
						...
						window.location.href = "fertilizerListFe.jsp";
					}
				});
			} else {
				$("body").removeClass("show-spinner");
		...
		function detail(id){
			$("body").addClass("show-spinner");
			window.location.href = "fertilizerDetail.jsp?id="+id;
		}
	</script>
