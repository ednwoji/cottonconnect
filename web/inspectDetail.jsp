								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Name of Insect</label> <!--input type="ntext"
												class="form-control" required id="name" name="name"-->
												<div id="name_insect"></div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
									...
									<%--	<textarea maxlength="250" class="form-control" required
										...
										<div id="identification_insect"></div>
										</div>
									</div>
								</div>
				...
				.ready(
						function() {
							...
							if (id != null) {
								...
								$("#edit").attr("href", "insect.jsp?id=" + id);
								...
								$.ajax({
											...
											success : function(result) {
												...
												$("#name_insect").html(result.name);
												//$("#identification").val(result.identification);
												$("#identification_insect").html(result.identification);
												//$("#notes").val(result.notes);
												$("#notes_insect").html(result.notes);
												//$("#description").val(result.description);
												$("#description_insect").html(result.description);
