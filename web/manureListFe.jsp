...
<body id="app-container" class="menu-sub-hidden show-spinner">
				...
				<div class="col-12">
					<div class="mb-2">
						...
						<div class="top-right-button-container">
							<a href="manureFe.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function edit(id) {
			...
			window.location.href = "manureFe.jsp?id="+id;
		}
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					...
					success : function(result) {
						...
						window.location.href = "manureListFe.jsp";
					}
				});
			} else {
				$("body").removeClass("show-spinner");
		...
		function detail(id){
			$("body").addClass("show-spinner");
			window.location.href = "manureDetail.jsp?id="+id;
		}
	</script>
