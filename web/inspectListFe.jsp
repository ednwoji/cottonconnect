					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="inspectListFe.jsp">Insect</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add</li>
							</ol>
						</nav>
						<div class="top-right-button-container">
							<a href="insectFe.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function fillDataTable(id) {
 		...
 		function edit(id) {
			...
			window.location.href = "insectFe.jsp?id=" + id;
		}   
				...
				$
						.ajax({
							...
							success : function(result) {
								...
								window.location.href = "inspectListFe.jsp";
							}
						});
			} else {
				$("body").removeClass("show-spinner");
