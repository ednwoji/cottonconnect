								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Name</label>
											<div id="name_useful"></div>
										</div>
									</div>
								<div class="col-md-12">
										<div class="form-group">
											<label>Topic & Notes</label>
											<div id ="notes_useful"></div> 		
										</div>
									</div>    
								
						<!-- 				<div class="col-md-12">
										<div class="form-group">
											<label>External Links or Notes</label>
											<div id="identification_useful"></div>
										</div>
									</div>  -->
								</div>
								<div class="row">
		...
		$(document)
				.ready(
						function() {
							...
							$("#redirectUrl").val(getHomeUrl()+ '/usefullist.jsp');
							$("#add-form").attr("action", getUrl() + "/service/knowledge-center/save/");

							var id = $.urlParam('id');
							if (id != null) {

								$("#edit").attr("href", "useful.jsp?id=" + id);
								...
								$.ajax({
										...
										//		$("#name").val(result.name);
												$("#name_useful").html(result.name);
										//		$("#identification").val(result.identification);
												$("#identification_useful").html(result.identification);
										//		$("#notes").val(result.notes);
												$("#notes_useful").html(result.notes);
