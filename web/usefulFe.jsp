					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="usefullistFe.jsp">Useful
										information</a></li>
						...
						<div class="card-body">
							<form action=""
									...
									<div class="col-md-4">
										<div class="form-group">
											<label>Name</label> <input type="text" class="form-control" required
												id="name" name="name" oninput="validateInput('name')">
										</div>
									</div>

									<div class="col-md-4">
										<div class="form-group">
											<label>Topics or Notes</label>
											<textarea maxlength="250" class="form-control" required name="notes"
												id="notes" oninput="validateInput('notes')"></textarea>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>External link or notes</label>
											<textarea maxlength="500" class="form-control" required
												name="identification" id="identification" oninput="validateInput('identifcation')"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="modal-footer">
									<a href="usefullistFe.jsp" class="btn btn-outline-primary">Cancel</a>
    ...
    textarea.setCustomValidity("");
		...
		$(document).ready(function () {
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			...
			$("#redirectUrl").val(getHomeUrl() + "/usefulFe.jsp");
