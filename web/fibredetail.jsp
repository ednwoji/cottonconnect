					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="fibrelist.jsp">Fibre Quality</a></li>
			...
			<div class="row mb-4">
				<div class="col-12 mb-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Fibre Quality</label> <!-- <input type="text"
												class="form-control" required id="name" name="name">  -->
												<div id="name_fibre"></div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
										...
										<!-- 	<textarea maxlength="250" class="form-control" required
												...
												<div id ="identification_fibre"></div>
										</div>
									</div>
								</div>
					...
					<!--    <a class="btn btn-primary" id="edit">Edit</a>  --> 
							<a 	href="fibrelist.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
		...
		$(document)
				.ready(
						function() {
							...
							$("#redirectUrl").val(getHomeUrl() + '/fibrelist.jsp');
							$("#add-form").attr("action", getUrl() + "/service/knowledge-center/save/");

							var id = $.urlParam('id');
							if (id != null) {

								$("#edit").attr("href", "fibre.jsp?id=" + id);
							...
							//					$("#name").val(result.name);
								  				$("#name_fibre").html(result.name);
							//					$("#identification").val(result.identification);
												$("#identification_fibre").html(result.identification);
							//					$("#notes").val(result.notes);
												$("#notes_fibre").html(result.notes);
