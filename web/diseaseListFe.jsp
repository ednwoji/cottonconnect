...
<body id="app-container" class="menu-sub-hidden show-spinner">
					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="diseaseListFe.jsp">Disease</a></li>
								<li class="breadcrumb-item active" aria-current="page">List</li>
							</ol>
						</nav>
						<div class="top-right-button-container">
							<a href="diseaseFe.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function detail(id){
			...
			window.location.href = "diseaseDetail.jsp?id="+id;
		}
		
		function edit(id) {
			$("body").addClass("show-spinner");
			window.location.href = "diseaseFe.jsp?id="+id;
		}
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					...
					success : function(result) {
						...
						window.location.href = "diseaseListFe.jsp";
					}
				});
			} else {
				$("body").removeClass("show-spinner");
