		...
		<div class="container-fluid">
					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="diseaseList.jsp">Disease</a></li>
			...
			<div class="row mb-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Name of Disease</label> <!-- input type="text"
												class="form-control" required id="name" name="name"-->
												<div id="name_disease"></div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
				...
				<%--							<textarea maxlength="250" class="form-control" required
												...
												<div id="identification_disease"></div>
										</div>
									</div>
								</div>
							...
							<%--			<textarea maxlength="350" class="form-control" required
										        ...
										        <div id="description_disease"></div>
										</div>
									</div>
								</div>
			...
			<%--				<a class="btn btn-primary" id="edit">Edit</a>  --%>
								<a href="diseaseList.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
				...
				.ready(
						function() {
							...
							if (id != null) {
								...
								$("#edit").attr("href","disease.jsp?id="+id);
								...
								$.ajax({
									...
									//	$("#name").val(result.name);
										$("#name_disease").html(result.name);
									//	$("#identification").val(result.identification);
										$("#identification_disease").html(result.name);
									//	$("#notes").val(result.notes);
										$("#notes_disease").html(result.notes);
									//	$("#description").val(result.description);
										$("#description_disease").html(result.notes);
