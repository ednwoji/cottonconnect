				...
				<div class="col-12">
					<div class="mb-2">
						...
						<div class="top-right-button-container">
							<a href="cicrBroadcastAdd.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function fillDataTable () {
			$('#country-table').DataTable({
				processing: false,
				serverSide: false,
				ajax: getUrl() + '/cicrBroadcast/get/all'
			});
		...
		function deletez (id) {
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					url: getUrl() + '/cicrBroadcast/delete?id='
						+ id,
					...
					success: function (result) {
						...
						window.location.href = "cicrBroadcast.jsp";
					}
				});
			} else {
				$("body").removeClass("show-spinner");
