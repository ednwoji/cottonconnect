	...
	<main>
		<div class="container-fluid">
			<div class="row ">
				<div class="col-12">
					<div class="mb-2">
						<h1>Safety & Hygiene</h1>
						<nav
							class="breadcrumb-container d-none d-sm-block d-lg-inline-block"
							aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								<li class="breadcrumb-item"><a href="#">Service</a></li>
								<li class="breadcrumb-item"><a href="safetylist.jsp">Safety & Hygiene</a></li>
			...
			<div class="row mb-4">
				<div class="col-12 mb-4">
						...
						<div class="card-body">
							<form
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Safety & Hygiene</label> <!-- input type="text"
												class="form-control" required id="name" name="name">  -->
											<div id="name_safety"></div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
								...
								<!-- 		<textarea maxlength="250" class="form-control" required
											...
											<div id="identification_safety"></div>	
										</div>
									</div>
								</div>
					...
					<!-- 	<a class="btn btn-primary" id="edit">Edit</a>    -->	
							<a href="safetylist.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
		...
		$(document)
				.ready(
						function() {
							...
							$("#redirectUrl").val(getHomeUrl() +'/safetylist.jsp');
							$("#add-form").attr("action", getUrl() + "/service/knowledge-center/save/");

							var id = $.urlParam('id');
							if (id != null) {

								$("#edit").attr("href", "safety.jsp?id=" + id);
								...
								$.ajax({
										...
										//		$("#name").val(result.name);
												$("#name_safety").html(result.name);
										//		$("#identification").val(result.identification);
												$("#identification_safety").html(result.identification);
										//		$("#notes").val(result.notes);
												$("#notes_safety").html(result.notes);
