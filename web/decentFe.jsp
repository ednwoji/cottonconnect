					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="decentlistFe.jsp">Decent
										Work</a></li>
						...
						<div class="card-body">
							<form action="" id="add-form" method="post" enctype="multipart/form-data"
								...
								<div class="modal-footer">
									<a href="decentlistFe.jsp" class="btn btn-outline-primary">Cancel</a>
    ...
    textarea.setCustomValidity("");
		...
		$(document).ready(function () {
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			...
			$("#redirectUrl").val(getHomeUrl() + "/decentFe.jsp");
