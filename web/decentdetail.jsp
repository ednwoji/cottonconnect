					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="decentlist.jsp">Decent Work</a></li>
			...
			<div class="row mb-4">
				<div class="col-12 mb-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Decent Work</label> <!-- input type="text"
												class="form-control" required id="name" name="name">   -->
											<div id="name_decent"></div>	
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
					...
					<!--					<textarea maxlength="250" class="form-control" required
											...
											<div id="identification_decent"></div>	
										</div>
									</div>
								</div>
					...
					<!-- 		<a class="btn btn-primary" id="edit">Edit</a>   -->
							    <a 	href="decentlist.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
		...
		$(document)
				.ready(
						function() {
							...
							$("#redirectUrl").val( getHomeUrl() + '/decentlist.jsp');
							...
							if (id != null) {
								...
								$("#edit").attr("href", "decent.jsp?id=" + id);
								...
								$.ajax({
											...
											//	$("#name").val(result.name);
												$("#name_decent").html(result.name);
											//	$("#identification").val(result.identification);
												$("#identification_decent").html(result.name);
											//	$("#notes").val(result.notes);
												$("#notes_decent").html(result.notes);
