		...
		<div class="container-fluid">
				...
				<div class="col-12">
					<div class="mb-2">
						...
						<div class="top-right-button-container">
							<a href="brand.html" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row mb-4">
				<div class="col-12 mb-4">
					<div class="card">
						<div class="card-body">
							<table class="data-table data-table-feature data-tables-pagination" id="country-table">
								<thead>
									<tr>
										<th>Name</th>
										<th>Country</th>
	...
	<script type='text/javascript'>
        $(document).ready(function () {
            ...
            $('#country-table').DataTable({
                ...
                "serverSide": true,
                "searching": false,
                "ajax": getUrl() + '/master/programme/getAllBrands',
            });
        ...
        function deletez(id) {
			...
			if (confirm("Are you sure want to delete? Can't restore record once deleted")) {
				$.ajax({
					url : getUrl() + '/master/brand/delete?id='+id,
