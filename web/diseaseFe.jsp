						...
						<div class="card-body">
							<form action=""
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Name of Disease</label> <input type="text" class="form-control" required id="name" name="name" oninput="validateInput('name')">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<textarea maxlength="350" class="form-control" required name="description" id="description" oninput="validateInput('description')"></textarea>
											(Max. 500 chars)
										</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label>Upload Document<b style="color: red">[.pdf, .xls,.pptx,
								...
								<div class="modal-footer">
									<a href="diseaseListFe.jsp" class="btn btn-outline-primary">Cancel</a>
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			$('#add-form').prepend('<div class="alert alert-danger text-center border border-info">Uploaded Failed. Try again later</div>')
				...
				.fadeOut(300, function() {$(this).remove();});
					...
					$("#redirectUrl").val(getHomeUrl() + "/diseaseListFe.jsp");
