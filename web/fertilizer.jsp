								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Name of Fertilizer</label> <input type="text" class="form-control"
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<textarea maxlength="500" class="form-control" required
												name="identification" id="identification" oninput="validateInput('identification')" oninput="validateInput('identification')"></textarea>
											(Max. 500 chars)
										</div>
									</div>
								</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<textarea maxlength="500" class="form-control" required name="notes"
												id="notes" oninput="validateInput('notes')" oninput="validateInput('notes')"></textarea>
											(Max. 500 chars)
										</div>
									</div>
									<div class="col-md-4">
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			$('#add-form').prepend('<div class="alert alert-danger text-center border border-info">Uploaded Failed. Try again later</div>')
				...
				.fadeOut(300, function() {$(this).remove();});
					...
					$("#redirectUrl").val(getHomeUrl() + "/fertilizer.jsp");
