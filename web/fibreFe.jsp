...
<body id="app-container" class="menu-sub-hidden show-spinner">
					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="fibrelistFe.jsp">Fibre Quality
									</a></li>
						...
						<div class="card-body">
							<form action="" id="add-form" method="post" enctype="multipart/form-data"
								...
								<div class="modal-footer">
									<a href="fibrelistFe.jsp" class="btn btn-outline-primary">Cancel</a>
	...
	<script type='text/javascript'>
		...
		$(document).ready(function () {
			...
			$("#redirectUrl").val(getHomeUrl() + "/fibrelistFe.jsp");
