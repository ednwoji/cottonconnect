...
<body id="app-container" class="menu-sub-hidden show-spinner">
					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="usefulListFe.jsp">Useful Informations</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add</li>
							</ol>
						</nav>
						<div class="top-right-button-container">
							<a href="usefulFe.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		function edit(id) {
			...
			window.location.href = "usefulFe.jsp?id=" + id;
		}
				...
				$
						.ajax({
							...
							success : function(result) {
								...
								window.location.href = "usefullistFe.jsp";
							}
						});
			} else {
				$("body").removeClass("show-spinner");
		...
		function detail(id) {
			$("body").addClass("show-spinner");
			window.location.href = "usefuldetail.jsp?id=" + id;
		}
	</script>
