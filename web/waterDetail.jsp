...
<body id="app-container" class="menu-sub-hidden show-spinner">
	...
	<main>
		<div class="container-fluid">
					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="waterlist.jsp">Water</a></li>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Water in Agriculture</label> <!-- input type="text"
												class="form-control" required id="name" name="name">  -->
											    <div id="name_water"></div>	
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											...
											<div id="identification_water"></div>	
										</div>
									</div>
								</div>
			...
			<!-- 				<a class="btn btn-primary" id="edit">Edit</a>   -->
								<a	href="waterlist.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
		...
		$(document)
				.ready(
						function() {
							...
							$("#redirectUrl").val(getHomeUrl() +'/waterlist.jsp');
							$("#add-form").attr("action", getUrl() + "/service/knowledge-center/save/");

							var id = $.urlParam('id');
							if (id != null) {

								$("#edit").attr("href", "water.jsp?id=" + id);
		...
		//										$("#name").val(result.name);
												$("#name_water").html(result.name);
		//										$("#identification").val(result.identification);
												$("#identification_water").html(result.identification);
		//										$("#notes").val(result.notes);
												$("#notes_water").html(result.notes);
