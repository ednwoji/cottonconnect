					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="icsList.jsp">Learner Group / ICS</a></li>
								<li class="breadcrumb-item active" aria-current="page">List</li>
							</ol>
						</nav>
						<div class="top-right-button-container">
							<a href="ics.jsp" class="btn btn-primary">ADD NEW</a>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript'>
        $(document).ready(function () {
            ...
            $('#country-table').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": getUrl() + '/master/farm-group/getAllLearners',
            });
        ...
        function edit(id) {
			...
			window.location.href = "ics.jsp?id=" + id;
		}
