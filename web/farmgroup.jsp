...
<body id="app-container" class="menu-sub-hidden show-spinner">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Type</label> <select id="typez" class="form-control"
											onchange="showHideLatLon(this.value)">
											<option value="">Select</option>
											<option value="1">Farm Group</option>
											<option value="2">PU</option>
											<option value="3">Organic Farm Group</option>
										</select>
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="modal-footer">
								<a href="farmgrouplist.jsp" class="btn btn-outline-primary">Cancel</a>
	...
	<script type='text/javascript'>
		...
		function edit(id){
			...
			$.ajax({
				url : getUrl() + '/master/farm-group/by-id/'+id,
		...
		function populatePartners() {
			...
			$.ajax({
				url : getUrl() + '/master/partner/by-program?program='
						+ program + '',
				beforeSend : function(request) {
					request.setRequestHeader("user-id", getUserName());
				},
