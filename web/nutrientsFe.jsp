					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="nutrientListFe.jsp">Nutrient</a></li>
						...
						<div class="card-body">
							<form action="" id="add-form" method="post" enctype="multipart/form-data"
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Name of Nutrients</label> <input type="text" class="form-control"
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<textarea maxlength="500" class="form-control" required name="description"
								...
								<div class="modal-footer">
									<a href="nutrientListFe.jsp" class="btn btn-outline-primary">Cancel</a>
		...
		$(document)
			.ready(
				function () {
					...
					$("#redirectUrl").val(getHomeUrl() + "/nutrientListFe.jsp");
