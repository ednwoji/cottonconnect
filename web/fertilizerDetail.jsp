					...
					<div class="mb-2">
						...
						<nav
							...
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="fertilizerList.jsp">Fertilizer</a></li>
			...
			<div class="row mb-4">
				<div class="col-12 mb-4">
					<div class="card">
						<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Name of Fertilizer</label> <!-- input type="text"
												class="form-control" required id="name" name="name">  -->
										     <div id="name_fertilizer"></div>		
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<label>Type</label><br /> <label> <input
												type="radio" value="1" name="typez" checked="checked">Organic
							...
							<!-- 				<textarea maxlength="250" class="form-control" required
										...
										<div id="identification_fertilizer"></div>		
										</div>
									</div>
								</div>
					...
					<!-- 		<a class="btn btn-primary" id="edit">Edit</a>  --> 
								<a href="fertilizerList.jsp" class="btn btn-outline-primary">Cancel</a>
						</div>
					</div>
				</div>
			</div>
				...
				.ready(
						function() {
							...
							if (id != null) {
								...
								$("#edit").attr("href", "fertilizer.jsp?id=" + id);
								...
								$
										.ajax({
											...
											//	$("#name").val(result.name);
												$("#name_fertilizer").html(result.name);
											//	$("#identification").val(
											//			result.identification);
												$("#identification_fertilizer").html(result.identification);
											//  $("#notes").val(result.notes);
											    $("#notes_fertilizer").html(result.notes);
											//	$("#description").val(
											//			result.description);
