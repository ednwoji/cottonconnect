					...
					<div class="mb-2">
						...
						<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
							<ol class="breadcrumb pt-0">
								...
								<li class="breadcrumb-item"><a href="manureListFe.jsp">Manure</a></li>
						...
						<div class="card-body">
							<form action="" id="add-form" method="post" enctype="multipart/form-data"
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Name of Manure</label> 
											<input type="text" class="form-control" required id="name" name="name" required oninput="validateInput('name')">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label>Upload Image<b style="color: red">[.jpg, .png]</b> [Max size : Upto to
												...
												type="file" accept="image/jpeg, image/png" name="file" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="modal-footer">
									<a href="manureListFe.jsp" class="btn btn-outline-primary">Cancel</a>
		  ...
		  if (currentUrl.indexOf('failed') !== -1) {
			$('#add-form').prepend('<div class="alert alert-danger text-center border border-info">Uploaded Failed. Try again later</div>')
				...
				.fadeOut(300, function() {$(this).remove();});
					...
					$("#redirectUrl").val(getHomeUrl() + "/manureListFe.jsp");
